// Enhanced Single Player Blackjack with Classes, Grid System and Multiple Screens
...
class Card {
  ...
  // Linear interpolation function to move the card smoothly
  update() {
    if (this.moving) {
...
class Deck {
  ...
  // Deals a card to hand takes in a hand dealer or player, then the x and y position it will be placed
  // and for dealer the boolean is promts on input true to hide a card and for player it's default is false
...
resolveGame() {
  ...
  handlePlayerActionClick() {
    ...
    // Hit button (matches the drawn button at 380,650 80x40)
